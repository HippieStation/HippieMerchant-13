...
#define JOB_DISPLAY_ORDER_RED_TEAM_ADMIRAL 37
#define JOB_DISPLAY_ORDER_RED_TEAM_MEMBER 38
#define JOB_DISPLAY_ORDER_BLUE_TEAM_ADMIRAL 39
#define JOB_DISPLAY_ORDER_BLUE_TEAM_MEMBER 40
