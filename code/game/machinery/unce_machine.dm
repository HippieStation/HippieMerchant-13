/obj/machinery/unce_machine
	...
	var/on = FALSE
	var/unce_file = 'sound/machines/unce.ogg'
...
/obj/machinery/unce_machine/attack_hand(mob/living/user)
	...
	switch(option)
		if("Adjust unce speed")
			if(unce_file == 'sound/machines/disco_unce.ogg') //This file lasts too long for the player to have free reign over its speed.
