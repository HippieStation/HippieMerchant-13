...
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/generate_heretic_z_level()
...
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/obtain_targets(mob/living/user, silent = FALSE)
	...
	for(var/datum/mind/head_mind as anything in shuffle(valid_targets))
		if(head_mind.assigned_role?.departments & DEPARTMENT_COMMAND)
	...
	for(var/datum/mind/sec_mind as anything in shuffle(valid_targets))
		if(sec_mind.assigned_role?.departments & DEPARTMENT_SECURITY)
	...
	for(var/datum/mind/department_mind as anything in shuffle(valid_targets))
		if(department_mind.assigned_role?.departments & user.mind.assigned_role?.departments)
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/sacrifice_process(mob/living/user, list/selected_atoms)
	...
	if(sacrifice.mind?.assigned_role?.departments & DEPARTMENT_COMMAND)
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/begin_sacrifice(mob/living/carbon/human/sac_target)
	. = FALSE
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/after_target_sleeps(mob/living/carbon/human/sac_target, turf/destination)
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/after_target_wakes(mob/living/carbon/human/sac_target)
	if(QDELETED(sac_target))
		return
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/after_helgrasp_ends(mob/living/carbon/human/sac_target)
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/return_target(mob/living/carbon/human/sac_target)
	if(QDELETED(sac_target))
		return
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/on_target_death(mob/living/carbon/human/sac_target, gibbed)
	SIGNAL_HANDLER
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/on_target_escape(mob/living/carbon/human/sac_target, old_z, new_z)
	SIGNAL_HANDLER
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/after_return_live_target(mob/living/carbon/human/sac_target)
 ...
 */
/datum/eldritch_knowledge/hunt_and_sacrifice/proc/after_return_dead_target(mob/living/carbon/human/sac_target)
	...
	var/obj/effect/visible_eldritch_influence/illusion = new(get_turf(sac_target))
