...
/datum/eldritch_knowledge/spell/on_research(mob/user)
 ...
 */
/datum/eldritch_knowledge/limited_amount/starting
	abstract_parent_type = /datum/eldritch_knowledge/limited_amount/starting
	mutually_exclusive = TRUE
	limit = 2
	cost = 1
	priority = MAX_KNOWLEDGE_PRIORITY - 5

/datum/eldritch_knowledge/limited_amount/starting/New()
	. = ..()
...
/datum/eldritch_knowledge/curse/on_finished_recipe(mob/living/user, list/selected_atoms,  turf/loc)
 ...
 */
/datum/eldritch_knowledge/curse/proc/curse(mob/living/carbon/human/chosen_mob)
 ...
 */
/datum/eldritch_knowledge/curse/proc/uncurse(mob/living/carbon/human/chosen_mob)
	SHOULD_CALL_PARENT(FALSE)
...
/datum/eldritch_knowledge/knowledge_ritual/on_research(mob/user)
	. = ..()
...
/datum/eldritch_knowledge/knowledge_ritual/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	var/drain_message = pick(strings(ELDRITCH_INFLUENCE_FILE, "drain_message"))
...
/datum/eldritch_knowledge/final/on_research(mob/user)
	. = ..()
	var/datum/antagonist/heretic/heretic_datum = IS_HERETIC(user)
	var/total_points = 0
	for(var/datum/eldritch_knowledge/knowledge as anything in flatten_list(heretic_datum.researched_knowledge))
 ...
 */
/datum/eldritch_knowledge/final/proc/is_valid_sacrifice(mob/living/carbon/human/sacrifice)
